...
class Cart extends Model {
	...
	public function save()
	{
		// verifica se o CEP Existe 
			if (@$this->setdeszipcode()!="") {

				$deszipcode = $this->setdeszipcode();
			} elseif(@$_SESSION["deszipcode"]){

				$deszipcode = $_SESSION["deszipcode"];
			}elseif(@$this->getidaddress()){
