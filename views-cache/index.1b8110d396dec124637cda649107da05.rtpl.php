				...
				<ul class="" id="bxslider-home4">
					...
					<li>
                      <a href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="view-details-link">
						<img src="/res/site/img/h4-slide2.png" alt="Acrecentar tabela Propaganda img" style="height: 400px" alt="Slide">
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-carousel-price">
                                    <ins>R$ <?php echo formatPrice($value1["vlprice"]); ?></ins> <!-- <del>$1355.00</del> -->
                                </div>                                 
                            </div>
                            <?php } ?>
